ackage com.parkit.parkingsystem.constants;
...
public class DBConstants {
    ...
    public static final String GET_VEHICLE_REG_NUMBER = "select VEHICLE_REG_NUMBER from ticket WHERE VEHICLE_REG_NUMBER = ? AND OUT_TIME IS NOT NULL";
